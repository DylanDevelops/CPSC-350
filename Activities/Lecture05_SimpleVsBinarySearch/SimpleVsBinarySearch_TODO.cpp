...
int binarySearch(int* arr, int len, int key){
    ...
    while(right >= left) {
        ...
        if(arr[middle] == key) {
            idx = middle; // We have found the key
            break;
        }
    ...
    cout << "I did " << comparisons << " comparisons in the binary search" << endl;
